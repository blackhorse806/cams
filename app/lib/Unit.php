...
class Unit {
	...
	public function __construct($variation_id = null, $db = null) {
		...
		if ($variation_id != null && $db != null) {
			...
			if ($this->exists()) {
				$this->attribute["core"] = new Unit_Attribute_Core($this->variation_id, $this->db, "unit");
				$this->attribute["outcomes"] = new Unit_Attribute_Outcomes($this->variation_id, $this->db, "unit_outcomes");
				$this->attribute["assessments"] = new Unit_Attribute_Assessments($this->variation_id, $this->db, null);
				$this->attribute["courses"] = new Unit_Attribute_Courses($this->variation_id, $this->db, "unit_courses");
				$this->attribute["prerequisite"] = new Unit_Attribute_Prerequisite($this->variation_id, $this->db, "unit_related_units");
				$this->attribute["corequisite"] = new Unit_Attribute_Corequisite($this->variation_id, $this->db, "unit_related_units");
				$this->attribute["equivalent"] = new Unit_Attribute_Equivalent($this->variation_id, $this->db, "unit_related_units");
				$this->attribute["incompatible"] = new Unit_Attribute_Incompatible($this->variation_id, $this->db, "unit_related_units");
				$this->attribute["work_integrated_learning"] = new Unit_Attribute_WIL($this->variation_id, $this->db, "unit_work_integrated_learning");
				$this->attribute["accreditation"] = new Unit_Attribute_Accreditation($this->variation_id, $this->db, "unit_accreditation");
				$this->attribute["discontinuation"] = new Unit_Attribute_Discontinuation($this->variation_id, $this->db, "unit_discontinuation");
				$this->attribute["discontinuation_arrangements"] = new Unit_Attribute_Discontinuation_Arrangements($this->variation_id, $this->db, "unit_discontinuation_arrangements");
				$this->attribute["offerings"] = new Unit_Attribute_Offerings($this->variation_id, $this->db, "unit_offerings");
				$this->attribute["timetabling"] = new Unit_Attribute_Timetabling($this->variation_id, $this->db, "unit_timetabling");
				$this->attribute["readings"] = new Unit_Attribute_Readings($this->variation_id, $this->db, "unit_readings");
				$this->attribute["responsible_schools"] = new Unit_Attribute_Schools($this->variation_id, $this->db, "unit_responsible_schools");
				$this->attribute["editors"] = new Unit_Attribute_Editors($this->variation_id, $this->db, "unit_editors");
            }
		}
	}
	...
	public function create($user) {
		...
		// Create unit record
		$unit_stmt = $this->db->prepare("INSERT INTO unit (proposal_type, state, date_started, approved, current) VALUES ('New Unit', 'Editing', CURDATE(), false, false)");
    ...
    public function get_modes_of_delivery($session) {
        ...
        // Find all unique sessions
        foreach ($data as $value) {
            if ($value['session'] == $session && $value['location'] == $data[0]['location']) {
...
class Unit_Attribute_Core extends Attribute {
...
class Unit_Attribute_Courses extends Attribute {
...
class Unit_Attribute_Assessments extends Attribute {
...
class Unit_Attribute_Outcomes extends Attribute {
	public function save($data) {
		if ($data == null) {
			return true;
		}
...
class Unit_Attribute_Prerequisite extends Attribute {
...
class Unit_Attribute_Corequisite extends Attribute {
	protected function retrieve() {
...
class Unit_Attribute_Equivalent extends Attribute {
	protected function retrieve() {
...
class Unit_Attribute_Incompatible extends Attribute {
	protected function retrieve() {
...
class Unit_Attribute_WIL extends Attribute {
	protected function retrieve() {
		$temp = $this->retrieve_data("*", $this->table, "unit_id = " . $this->variation_id);
		if (count($temp) > 0) {
			$this->data = $temp[0];
...
class Unit_Attribute_Accreditation extends Attribute {
	public function save($data) {
		if ($data == null) {
			return true;
		}
...
class Unit_Attribute_Discontinuation extends Attribute {
	public function save($data) {
		if ($data == null) {
			return true;
		}
...
class Unit_Attribute_Discontinuation_Arrangements extends Attribute {
	public function save($data) {
		if ($data == null) {
			return true;
		}
...
class Unit_Attribute_Offerings extends Attribute {
	public function save($data) {
		if ($data == null) {
			return true;
		}
...
class Unit_Attribute_Timetabling extends Attribute {
	public function save($data) {
		if ($data == null) {
			return true;
		}
...
class Unit_Attribute_Schools extends Attribute {
	public function save($data) {
		if ($data == null) {
			return true;
		}
...
class Unit_Attribute_Readings extends Attribute {
	protected function retrieve() {
...
class Unit_Attribute_Editors extends Attribute {
